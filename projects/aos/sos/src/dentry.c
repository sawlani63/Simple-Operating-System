...
#define DENTRY_CACHE_SIZE 16 // Dentry cache is as big as the amount of files we can have (16 with 1 process)
 ...
 * This should take up 1B (flags) + 512B (keys) + 512B (values) ≈ 1KB of space */
int dentry_init() {
